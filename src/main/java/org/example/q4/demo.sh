...
# Question 4 demo script
# Usage: ./demo.sh [test1|test2|test3]

USER=vothanh
HDFS_DIR=/user/$USER
HDFS_INPUT_DIR=$HDFS_DIR/question4/input
HDFS_OUTPUT_DIR=$HDFS_DIR/question4/output
...
case $TEST_CASE in
    "test1")
        echo "Running test1"
        hadoop jar question4.jar Question4 $HDFS_INPUT_DIR/test1 $HDFS_OUTPUT_DIR/test1
        echo "Results:"
